...
Window::Window() 
{
    ...
    m_window.setPosition({ (int) (desktop.size.x / 2 - m_config.width / 2), (int) (desktop.size.y / 2 - m_config.height / 2) });
...
void Window::Initialize()
{
    ...
    std::filesystem::path fontPath = std::filesystem::path(ASSET_DIR) / "fonts" / "Minecraft.ttf";
